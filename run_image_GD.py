...
- Partial_dft : The ensemble described in the Maleki paper, randomly susbampled dft x random phases
...
for RGB_channel in range(RGB):
    ...
    for ensemble in ensembles:
        if not(RGB_channel == 0 and ensemble == "partial_dft"): #FIXME Because I already ran those
